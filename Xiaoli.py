...
data = pd.read_excel('C:/Users/ibra5/Desktop/Internships/GAC/Xiaoli/Values.xlsx')
...
plt.plot(right_angular_velocity, color='black', label='Foot Angular VelocityX')
plt.plot(left_angular_velocity, color='blue', label='Foot Angular VelocityY')
